...
export default function Footer() {
  return (
    <footer className="relative bg-[#05070a] border-t border-white/[0.08] text-slate-400 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
          ...
          <div className="flex flex-col items-start space-y-3">
            ...
            <p className="text-slate-400 max-w-sm text-xs leading-relaxed">
              Official Cybersecurity Club operating under the Central Coding Club at 
              Samrat Ashok Technological Institute (SATI), Vidisha.
            </p>
            <div className="text-[11px] font-mono text-[#00e5ff]">
              Learn &rarr; Practice &rarr; Build &rarr; Compete &rarr; Secure
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2.5 text-xs">
            {links.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="text-slate-300 hover:text-[#00e5ff] transition-colors"
              >
                {link.name}
              </Link>
            ))}
          ...
          {/* Right Motto & Socials */}
          <div className="flex flex-col lg:items-end space-y-3 shrink-0">
            {/* Social Channels (SVG Icons) */}
            ...
            <div className="font-mono text-xs text-slate-400">
              <span className="text-white font-medium">Think Secure.</span> Build Better.
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 text-[11px] font-mono">
          <div>
            &copy; {new Date().getFullYear()} Cyber Cell. All rights reserved.
          </div>
